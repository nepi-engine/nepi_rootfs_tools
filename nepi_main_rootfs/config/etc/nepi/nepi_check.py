...
DEVELOPER_LICENSE_DICT = {'licensed_components':{'nepi_base':{'commercial_license_type': 'Developer'}}}
...
def checkLicense():
    try:
        ...
        with open(LICENSE_WARNING_FILE, 'w') as f:
            f.write("THIS DEVICE IS RUNNING A DEVELOPER-LICENSED VERSION OF NEPI. NOT FOR COMMERCIAL USE.\n")
            f.write("-----------------------------------------------------------------------------------\n")
            f.write("Failed to validate commercial license: " + str(e) + "\n")
            #print("Debug: " + str(e))
        exception_license = DEVELOPER_LICENSE_DICT.copy()
